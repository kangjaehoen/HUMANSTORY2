...
<%--<footer class=" fixed p-4 bg-gray-800 md:p-4 lg:p-5 w-full">--%>
<%--    <div class="mx-auto max-w-screen-xl text-center">--%>
<%--        <a href="#"--%>
<%--           class="flex justify-center items-center text-2xl font-semibold text-gray-900 dark:text-white">--%>
<%--            <img src="/img/sideBarLogo.png" class="h-14 me-2" alt="HS Logo" />--%>
...
<%--    </svg> -->--%>
<%--        </a>--%>
<%--        <p class="my-6 text-gray-500 dark:text-gray-400">Take a Break, Unlock Your Potential</p>--%>
