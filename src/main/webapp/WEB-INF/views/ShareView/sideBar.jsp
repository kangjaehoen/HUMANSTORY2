                ...
                <div class="flex items-center ms-3">
                    ...
                    <div>
                        <button type="button" class="flex p-1 text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-whitetext-white" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                            ...
                            <img class="w-8 h-8 rounded-full border-2" src="/img/profilePhoto/<sec:authentication property='principal.emp.empNum'/>.png" alt="user photo">
                    ...
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-whitetext-white" id="dropdown-user">
                        <div class="px-4 py-3" role="none">
                            <p class="text-sm font-medium text-black hover:text-gray-900" role="none">
                                사원번호 : [ <sec:authentication property='principal.emp.empNum'/> ]
                            </p>
                            <p class="text-sm font-medium text-black hover:text-gray-900" role="none">
                                부서번호 : [ <sec:authentication property='principal.emp.deptNum'/> ]
                            </p>
                        </div>
                        <ul class="py-1" role="none">
                            ...
                            <li>
                                <a href="/leavePolicy/list" class="block px-3 py-1 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-whitetext-white dark:hover:text-white" role="menuitem">Settings</a>
                            </li>
                            <li>
...
<%--        Side bar 사원 개인 정보 출력--%>
        <div class="flex justify-center items-center mt-8">
            <!--   <img id="EmpProFile" class="w-24 h-24 rounded-full border-2" src="" alt=""> -->
            <div id="EmpProFile">
                <img src="/img/profilePhoto/<sec:authentication property='principal.emp.empNum'/>.png" class="w-24 h-24 rounded-full border-2" />
            </div>
        </div>
        ...
        <p class="text-sm text-white dark:text-white text-center" role="none"><sec:authentication property="principal.emp.job" /></p>
...
<%--            Alert--%>
            ...
            <div x-data="{ open: false }">
                <li>
                    <a href="#" class="flex items-center p-2 text-white hover:text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <button @click="open = !open" class="flex justify-between items-center pl- text-gra cursor-pointer focus:outline-none">
                    ...
                    <div x-show="open" class="bg-gray-800 rounded-lg">
                        ...
                        <a class="py-2 px-16 block text-sm text-white hover:bg-blue-500 hover:text-gray-900 hover:bg-white rounded-lg text-center" href="/leave/gridList">PTO List</a>
                    </div>
                </li>
            </div>
            <!-- Dashboard -->
            <li>
                <a href="/approve/list" class="flex items-center p-1.5 text-white hover:text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg class="w-6 h-6 text-gray-100 transition duration-75 dark:text-gray-400 group-hover:text-white hover:text-gray-900 dark:group-hover:text-gray-100" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd" d="M9 2a1 1 0 0 0-1 1H6a2 2 0 0 0-2 2v15a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2h-2a1 1 0 0 0-1-1H9Zm1 2h4v2h1a1 1 0 1 1 0 2H9a1 1 0 0 1 0-2h1V4Zm5.707 8.707a1 1 0 0 0-1.414-1.414L11 14.586l-1.293-1.293a1 1 0 0 0-1.414 1.414l2 2a1 1 0 0 0 1.414 0l4-4Z" clip-rule="evenodd"/>
                    </svg>

                    <span class="flex-1 ms-2.5 whitespace-nowrap">Approvals</span>
            ...
            <div x-data="{ open: false }">
                <li>
                    <a href="#" class="flex items-center p-1 text-white hover:text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <button @click="open = !open" class="flex justify-between items-center pl- text-gra cursor-pointer ">
                            ...
                            <span>
                     <svg class="h-4 w-4" viewBox="0 0 14 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path x-show="! open" d="M9 5L16 12L9 19" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display: none;"></path>
                      <path x-show="open" d="M19 9L12 16L5 9" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                      </svg>
                      </span>
