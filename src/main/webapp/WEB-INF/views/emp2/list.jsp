        ...
        $(document).ready(
            function() {
                    ...
                    .on(
                        ...
                        function() {
                            ...
                            var name = $(this).parent().children()
                                .eq(0).text();
                            $.post("ajaxpicture.it", {empNum : empNum}, function(data) {
                ...
                $("button.pictureInsertForm").on("click", function() {
                    ...
                    $("#pictureInsertForm #empNum").val($(this).parents("tr").children().eq(0).text());
                    console.log($("#pictureInsertForm #empNum").val());
...
<%--                    </tr>--%>
                    ...
                    <tr>
                        ...
                        <td><button type="button"
                                    class="btn btn-default btn-xs  delete" value="${emp.empNum}">삭제</button></td>

                        <!-- 수정 액션을 위한 버튼(<a> 태그)에 getString 직원번호 추가 -->
                        <td><a href="employeeupdateform.it?empNum=${emp.empNum}" role="button"
