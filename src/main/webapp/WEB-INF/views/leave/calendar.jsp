...
<%-------------------Modal 시작----------------------------------------------------------------------------------------------------------------------------------------------%>
			...
			<div x-show.transition.opacity="isEventModalOpen"
				...
				<div @click.stop
					class="bg-gray-600 rounded-2xl border-2 border-blue-500 overflow-auto w-1/3 h-9/10 p-10 ">
					...
					<div class="flex items-center mb-4">
						<form action="${pageContext.request.contextPath}/leave/register" method="post">
							<div class="grid gap-4 mb-4 sm:grid-cols-2">
								...
								<div>
									<label for="empNum"
										class="block mb-2 text-sm font-bold text-white-900 dark:text-white">사원
										번호</label> <input type="text" name="empNum" id="empNum"
										class="bg-white-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-primary-500 dark:focus:border-primary-500"
								...
								<div date-rangepicker class="flex items-center">
									...
									<div class="relative">
										...
										<label for="datepicker"></label> <label for="startDate"></label><input name="startDate"
																											   type="text"
																											   class="mt-6 bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5   dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
								...
								<div>
									<label for="leaveType"
										...
										class="mt-6 bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-primary-500 dark:focus:border-primary-500">
								...
								<div class="sm:col-span-2">
									...
									<label for="leaveReason"></label><textarea id="leaveReason" name="leaveReason" rows="4"
																			   class="block p-2.5 w-full text-sm text-gray-900 bg-gray-100 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-primary-500 dark:focus:border-primary-500"
																			   placeholder="휴가 사유를 작성해 주세요"></textarea>
								</div>

							</div>
							<button type="submit"
								class="bg-blue-500 text-white px-4 py-2 rounded-lg mr-2 hover:bg-blue-800 hover:text-white-900">신청</button>
            ...
            <div x-show.transition.opacity="isEventDetailsModalOpen"
				...
				<div @click="isEventDetailsModalOpen = false"
					class="bg-white rounded-2xl border-2 border-blue-500 overflow-auto w-9/10 h-9/10 p-10">
					<div class="flex justify-center items-center mt-8">
						<img :src="'/img/profilePhoto/' + selectedEvent.empNum + '.png'" alt="Profile Photo" class="w-24 h-24 rounded-full border-2">
					</div>
			...
			<div @click.stop
				...
				<form action="/leave/modify" method="post">
					...
					<div date-rangepicker class="flex items-center">
						...
						<div class="relative">
							<label for="datepicker"
								class="block mb-2 text-sm font-bold text-gray-900 ">휴가
								시작일</label>
							<div
								class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
								<svg class="mt-6 w-4 h-4 text-gray-500 dark:text-gray-400"
					...
					<div>
						<label for="leaveType"
							class="block mb-2 text-sm font-bold text-gray-900">휴가유형</label>
