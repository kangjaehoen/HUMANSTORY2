...
<%--         pageEncoding="UTF-8"%>--%>
<%--&lt;%&ndash;<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>--%>
<%--<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>&ndash;%&gt;--%>
...
<%--    <div><a id="policyNav1" href="/leavePolicy/list">휴가 정책</a></div>--%>
<%--</div>--%>
