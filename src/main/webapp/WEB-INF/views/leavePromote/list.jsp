                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <c:forEach items="${list}" var="leavePromote">
                            <tr class="border-b dark:border-gray-700">
                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">${leavePromote.lprNum }</th>

                                <td class="px-4 py-3">${leavePromote.title }</td>
                                <td class="px-4 py-3">${leavePromote.empNum }</td>
