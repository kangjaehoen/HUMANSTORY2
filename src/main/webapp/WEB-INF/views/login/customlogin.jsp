    ...
    <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
        <form class="bg-white" action="/customlogin" method="POST">
            ...
            <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4 w-[330px]">
                ...
                <input class="pl-2 outline-none border-none" type="text" name="username" id="empNum" placeholder="사원번호" />
            ...
            <div class="flex items-center border-2 py-2 px-3 rounded-2xl">
                ...
                <input class="pl-2 outline-none border-none" type="password" name="password" id="pw" placeholder="비밀번호" />
